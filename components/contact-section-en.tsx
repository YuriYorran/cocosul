...
export default function ContactSectionEN() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Here would be the call to the real API
      ...
      <div className="container">
        <div className="contact-content">
          <div className="contact-intro">
            <h2 className="section-title">Contact CocoSul</h2>
            <p className="intro-text">
              Need a reliable supplier of coconut derivatives? Talk to those who understand the subject. 
              Our team is ready to answer your questions, send quotes and start a lasting partnership.
            </p>
          </div>
            ...
            <div className="contact-info">
              <div className="contact-details">
                ...
                <div className="contact-item">
                  ...
                  <span>Londrina – PR | Deliveries throughout Brazil</span>
                </div>
              </div>
            </div>
