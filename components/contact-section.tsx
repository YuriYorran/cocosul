      ...
      <div className="container">
        <div className="contact-content">
          <div className="contact-intro">
            <h2 className="section-title">Fale com a CocoSul </h2>
            <p className="intro-text">
              Precisa de um fornecedor confiável de derivados de coco? Fale com quem entende do assunto. 
              Nossa equipe está pronta para responder suas dúvidas, enviar orçamentos e iniciar uma parceria duradoura.
            </p>
          </div>
            ...
            <div className="contact-info">
              <div className="contact-details">
                ...
                <div className="contact-item">
                  ...
                  <span>Londrina – PR | Entregas para todo o Brasil</span>
                </div>
              </div>
            </div>
