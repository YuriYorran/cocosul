...
export default function CocoRaladoFinoUmidoPage() {
  return (
    <>
      <main className="product-page">
        ...
        <section className="banner-section">
          <div className="banner-content">
            <h1>Coco Ralado Fino Úmido e Adoçado</h1>
            <p>Textura Fina para Aplicações Especiais</p>
          </div>
        </section>
          ...
          <div className="container">
            ...
            <div className="product-images-centered">
              <div className="image-grid">
                <Image
                  src="/cocoAdocadoFino.png"
                  alt="Coco Ralado Fino Úmido e Adoçado"
                  width={4200}
                  height={3000}
              ...
              <div className="product-buttons">
                <a 
                  href="https://wa.me/554333431357?text=Olá! Gostaria de comprar Coco Ralado Fino Úmido e Adoçado da CocoSul." 
                  target="_blank" 
            ...
            <div className="product-info-below">
              ...
              <p className="product-description">
                O Coco Ralado Fino Úmido e Adoçado da CocoSul é ideal para aplicações que 
                requerem uma textura mais refinada. Com granulometria fina, oferece uma 
                experiência sensorial única e é perfeito para receitas que demandam 
                uniformidade e delicadeza.
              </p>
              ...
              <div className="specifications">
                ...
                <div className="nutritional-info">
                  ...
                  <Image
                    src="/informacaoNutricionalFinoUmido.jpeg"
                    alt="Informação Nutricional - Coco Ralado Fino Úmido e Adoçado"
                    width={400}
                    height={300}
                    className="rounded-lg shadow-lg"
                  />
